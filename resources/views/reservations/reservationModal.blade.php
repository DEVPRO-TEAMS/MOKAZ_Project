            ...
            <div class="modal-body">
                ...
                <div class="step-content active" id="step1">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex gap-3">
                                <div class="card p-3 flex-fill text-center type-sejour-card" data-type="jour"
                                    ...
                                    <label class="btn btn-outline-primary w-100" for="sejour_jour">
                                ...
                                <div class="card p-3 flex-fill text-center type-sejour-card" data-type="heure"
                                    ...
                                    <label class="btn btn-outline-primary w-100" for="sejour_heure">
                        ...
                        <div id="bloc-jour" class="row g-3 d-none">
                            <div class="col-md-6">
                        ...
                        <div id="bloc-heure" class="col-md-6 d-none">
